...
/**
 * The systems index — the shared source of truth for the Systems / Projects
 * showcase, used by both the English route (/projects) and every localized
 * variant (/es/projects, …). Case-study titles and descriptions stay in
 * English by design: they are the records themselves, not page chrome.
 */
